...
router.get("/random", (req, res, next) => {
    Song.find()
        .then(songs => {
            ...
            console.log(
                songs.map(song => song.artistName + " --- " + song.name)
            );
